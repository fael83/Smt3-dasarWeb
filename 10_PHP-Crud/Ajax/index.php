...
<head>
    ...
    integrity="sha384-WvFPogKV6tAHSp1vLGOFQNHS0ozbE+QkPCxCAFINeevOEH3S1O5IbcOQVNN" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" 
    integrity="sha384-fnmOCQbTcmK4rO5CqSjC1BbVbL1lJg07vJ7r9hPvL6H6y4Ew2V5a/lJbQ2V2pB2lG" crossorigin="anonymous">
...
<body>
    ...
    <div class="container" style="margin-top: 30px;">
        <h2 class="align-center" style="margin: 30px;">Data Anggota</h2>
